...
void loop() {
  ...
  // put your main code here, to run repeatedly:
        ...
        {
          String kind_c1, status_c1, kind_ir1, status_ir1;
                    if (r_time > 20000) 
                    {
                       ...
                       if (httpCode == 200) {
                          ...
                          while (get_http.connected())  {
                              if (stream->available())  {
                                  ...
                                  if (root.success()) {
                                      //JsonArray& slots = root["slots"];
                                      //JsonObject control = slots["control"];
                                      //String kind_c = control["kind1"];
                                      //String status_c = control["status1"];
                                      //JsonObject ir = slots["ir"];
                                      //String kind_ir = s["kind2"];
                                      //String status_ir = s["status2"];
                                      JsonObject& s = root["s"];
                                      //String kind_c = s["ir"];
                                      //String kind_ir = s["kind2"];
                                      String status_c = s["ir"];
                                      String status_ir = s["control"];
                                      //kind_c1 = kind_c;
                                      //kind_ir1 = kind_ir;
                                      status_c1 = status_c;
